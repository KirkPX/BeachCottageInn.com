<?php
    /**
     * onecore - the one page cms
     * (c) 2007 by Remo Fritzsche
     * remofritzsche.ch
     * remofritzsche.ch/onecore
    */
...
<p>Please bear with us as we update our content. Current news, updates and packages will be made available here!</p>
<?php
    ...
    // Check for permissions
   	...
   	if (isset($_GET['login']))
   	{
   		if (!isset($_GET['do']))
   		{
	    	...
	    	echo '<input type="reset" value="Abbort" onClick="history.back()" />';
	    	echo '</form>';
   		}
   		else
   		{
